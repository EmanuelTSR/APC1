...
int main() {
  ...
  singned int inteiro_com_sinal // 4 bytes -2bi a 2bi
  
  short int inteiro_curto; //2 bytes -32mil a 32mil
  unsigned short int inteiro_curto_sem_sinal; // 2bytes 0 a 65mil

  long int  inteiro_longo; // 8 bytes -9hexa a 9hexa
  unsigned long int inteiro_longo_com_sinal; //8bytes 0 a 9hexa 
